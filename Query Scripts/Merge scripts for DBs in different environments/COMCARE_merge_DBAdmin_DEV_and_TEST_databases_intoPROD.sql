...
--Short term fix for server with the wrong name
UPDATE [DBAdmin].[dbo].[Checks_Database_Information]
SET ServerName = 'PCBR01VPREM01'
WHERE ServerName = 'TCBR03VPREM01'

UPDATE [DBAdmin].[dbo].[Checks_AgentJobs]
SET ServerName = 'PCBR01VPREM01'
WHERE ServerName = 'TCBR03VPREM01'

UPDATE [DBAdmin].[dbo].[Checks_DataFiles]
SET ServerName = 'PCBR01VPREM01'
WHERE ServerName = 'TCBR03VPREM01'
